  ...
  <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="1">
            <div style="position:absolute; width:302px; top:30px; background:url(theme/images/chevrolet-logod.png);">
            ...
            <div id="slogan">
             <div style="position:absolute; top:10px; left:378px; margin-left:-400px; width:681px; height:25px; font-size:25px; color:#000; font-family:'Courier New', Courier, monospace;">
              <marquee direction="left" width="100%" scrollamount="7">
                <span class="Estilo9">CHEVROLET CENTER </span>
              </marquee></div>
            </div>
            <img src="theme/images/chevrolet-logod.png" alt="" width="666" height="196"></td>
            <td class="hbg">&nbsp;</td>
          </tr>
        </table></td>
      </tr>
    ...
    <div id="centercontent">
      <form action="mod_configuracion/login.php" method="post">
        <table width="200"  align="center" border="0">
          <tr>
            <td  align="center"><img  align="center" src="theme/images/chevrolet-logod.png" WIDTH=250	HEIGHT=260  align="right" alt="Hidrofalcon" /></td>
          </tr>
        </table>
        <div align="center">
          ...
          <td bgcolor="#0b7ca9" class="bot-bg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td class="bottom_addr">
                <img src="theme/images/footers.png" align="center" width="200" height="100"/>
