...
<form name="usuarios" action="../mod_usuarios/reg_usu.php" method="post">
			...
			<td class="dtabla">
				<select name="planta">
					...
					while($row2=mysql_fetch_assoc($result2)){
						...
						echo "<option $slt value=\"".$row2["planta"]."\">".$row2["desc_planta"]."</option>\n";
					}
					?>
				</select>	
			</td>
		...
		<tr>
			...
			<td class="dtabla">
				<select name="puesto">
					...
					while($row2=mysql_fetch_assoc($result2)){
						if ($row2["id_puesto"]==$_REQUEST["puesto"]){ $slt="selected ";}else{ $slt="";}
						echo "<option $slt value=\"".$row2["puesto"]."\">".$row2["desc_puesto"]."</option>\n";
					}
					?>
				</select>	
			</td>
		...
		<tr>
			...
			<td class="dtabla">
				<select name="departamento">
					...
					while($row2=mysql_fetch_assoc($result2)){
						if ($row2["id_depto"]==$_REQUEST["departamento"]){ $slt="selected ";}else{ $slt="";}
						echo "<option $slt value=\"".$row2["departamento"]."\">".$row2["desc_depto"]."</option>\n";
					}
					?>
				</select>	
			</td>
