  ...
  <div align="center">
    <table>
      <td>
        <form action="act_usu.php" method="post">
          ...
          <table class="tabla">
            <tr>
              <td colspan="2" align="center">Introduzca Login del Empleado</td>
		    </tr>
            <tr>
    ...
    <td>
      <form action="act_usu.php" method="post">
        ...
        <table class="tabla">
          <tr>
            <td colspan="2" align="center">Ingrese Nombre del Empleado</td>
		    </tr>
          <tr>
...
<tr>
	<td colspan="4" class="tdatos" align="center"><h3>DATOS DEL USUARIO</h3></td>
</tr>
<tr>
...
<tr>
	...
	<td>
		<select name="tipo">
			<option value="ME" <?php if ($tipo=="ME") echo "selected" ?>>CLIENTE</option>
		</select>
	</td>
</tr>
<tr>
